...
import org.rucca.cheese.model.PatchSpace200ResponseDTO
...
interface SpacesApi {
    ...
    suspend fun getSpace(
        ...
        @Valid
        @RequestParam(value = "queryCategories", required = false, defaultValue = "false")
        queryCategories: kotlin.Boolean,
        ...
        responses =
            [
                ApiResponse(
                    ...
                    description = "OK",
                    content =
                        [Content(schema = Schema(implementation = PatchSpace200ResponseDTO::class))],
                )
            ],
        security = [SecurityRequirement(name = "BearerAuth")],
    )
